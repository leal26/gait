...
GaitCreationDir = erase(GaitCreationDir, [filesep,'Models',filesep,'SLIP_SwingLeg',filesep,'DOE_phases.m']);
% ************************************
% ************************************
...
% Write to file
% fileID = fopen(strcat('DOE_phases.txt'),'w');
...
save('DOE_phases_finer.mat', 'result_matrix', 'parameters', 'parameters_nd', 'output')

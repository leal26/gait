function [ sigma, T, eps_t, MVF, H_cur, Phi_fwd, Phi_rev, h, chck ] = Elastic_Transformation_check_RI_TC( P, TP, eps, eps_prev,t, t_prev, T_prev, T0, sigma_prev, Phi_fwd_prev, Phi_rev_prev, E, MVF, eps_t, eps_t_r, MVF_r, r )
...
if P.h == 1
    ...
    Gr = 2*(T_prev - T0)/(T_prev + T0)*(g*P.d^3)/(nu_air^2);

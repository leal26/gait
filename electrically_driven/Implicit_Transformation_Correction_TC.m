function [ MVF, T, eps_t, E, MVF_r, eps_t_r, sigma, Phi_fwd, Phi_rev, pi_t ] = Implicit_Transformation_Correction_TC( P, TP, chck,MVF, eps_t, E,MVF_r,eps_t_r,sigma, H_cur,eps, T, T_0, Phi_fwd, Phi_rev )
...
elseif chck==1
    [ MVF, T, eps_t, E, MVF_r, eps_t_r, sigma, Phi_fwd, pi_t] = ...
...
elseif chck==2
    [ MVF, T, eps_t, E, MVF_r, eps_t_r, sigma, Phi_rev, pi_t] = ...
